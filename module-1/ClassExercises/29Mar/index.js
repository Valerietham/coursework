  ...
  data: [
    ...
    },
    {
      ...
      user: {
        username: 'carinstagram',
        profile_picture:
          'https://instagramimages-a.akamaihd.net/profiles/profile_23275345_75sq_1381623938.jpg',
        id: '23275345',
        full_name: 'Kik:SoLeimanRT',
      },
    },
    ...
    },
    {
      ...
      caption: {
        ...
        from: {
          ...
          profile_picture:
            'https://igcdn-photos-d-a.akamaihd.net/hphotos-ak-xpf1/t51.2885-19/11032891_610949965673163_728033182_a.jpg',
          id: '7563629',
    ...
    },
    {
      ...
      caption: {
        ...
        from: {
          username: 'jiffpom',
          profile_picture:
            'https://igcdn-photos-g-a.akamaihd.net/hphotos-ak-xaf1/t51.2885-19/10534848_1445438965724038_834552885_a.jpg',
          id: '194146115',
          full_name: 'jiff',
        },
...
function getImageDetailsByUser(fullName, imageArr) {
  ...
  for (let i = 0; i < imageArr.length; i++) {
    ...
    if (userDetails?.full_name === fullName && imageArr[i]?.images) {
      // Check the full_name of the userDetails is matching with the
...
console.log(getImageDetailsByUser('Salman Khan', instagramData.data));
